...
class Mill extends StatefulWidget {
  const Mill({Key? key}) : super(key: key);

  @override
  _MillState createState() => _MillState();
}

class _MillState extends State<Mill> {
  String? label1;
  String? label2;
  String? label3;
  String? label4;
  ...
  Future<List<String>> getData() async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
    if(prefs.containsKey("mills")){
      List<String>? values = prefs.getStringList("mills");
      if(values!.isEmpty) {
        setState(() {
          label1 = "Hello";
          label2 = "Hello";
